...
import { login, getGoogleLoginUrl, getAppleLoginUrl } from '@/lib/auth';
    ...
    <div className="min-h-screen bg-[var(--color-background)] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-muted)] text-sm mt-1">{t('auth.login', locale)}</p>
        </div>
        ...
        <div className="bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] shadow-sm p-8 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <button
              ...
              aria-busy={loading}
            >
              {loading ? t('auth.signing_in', locale) : t('auth.login', locale)}
            </button>
          </form>
          ...
          <div className="text-center space-y-2 pt-1">
            <p className="text-sm text-[var(--color-muted)]">
              ...
              <Link href="/register" className="text-[var(--color-blue)] font-medium hover:underline">
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-[var(--color-background)] flex items-center justify-center">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[var(--color-blue)]" />
        </div>
      }
    >
      <LoginForm />
