...
export const TEAM_IDS: Record<string, { sportsDbId: string; sport: string }> = {
  ...
  'Atletico Madrid': { sportsDbId: '133729', sport: 'football' },
  ...
  'Bayern Munich': { sportsDbId: '133664', sport: 'football' },
  'Juventus': { sportsDbId: '133676', sport: 'football' },
  'Inter Milan': { sportsDbId: '133681', sport: 'football' },
  'AC Milan': { sportsDbId: '133667', sport: 'football' },
  'Sevilla FC': { sportsDbId: '133735', sport: 'football' },
