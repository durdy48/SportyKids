...
INSERT INTO "new_ParentalProfile" ("allowedFeeds", "allowedFormats", "allowedHoursEnd", "allowedHoursStart", "allowedSports", "digestDay", "digestEmail", "digestEnabled", "failedAttempts", "id", "lastDigestSentAt", "lockedUntil", "maxDailyTimeMinutes", "maxNewsMinutes", "maxQuizMinutes", "maxReelsMinutes", "pin", "timezone", "userId") SELECT "allowedFeeds", "allowedFormats", "allowedHoursEnd", "allowedHoursStart", "allowedSports", "digestDay", "digestEmail", "digestEnabled", "failedAttempts", "id", "lastDigestSentAt", "lockedUntil", "maxDailyTimeMinutes", "maxNewsMinutes", "maxQuizMinutes", "maxReelsMinutes", "pin", "timezone", "userId" FROM "ParentalProfile";
