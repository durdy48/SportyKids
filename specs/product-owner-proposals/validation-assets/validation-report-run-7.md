...
**Date**: 2026-03-26T22:38:47.522Z
**Summary**: 102/108 passed, 6 failed, 0 skipped
...
| A03 | Search API actually filters (live test) | PASS | All: 3062, Nonsense search: 0 (filtered correctly) |
...
| D02 | /api/auth/upgrade has IDOR protection | FAIL | Does not compare userId with req.auth.userId |
...
| D06 | JWT_SECRET warns in production | FAIL | No production warning for missing JWT_SECRET |
...
| ID | Check | Status | Detail |
|----|-------|--------|--------|
| E01 | auth/upgrade requires requireAuth and enforces userId match | FAIL | requireAuth not on /upgrade route |
...
| E05 | POST /sincronizar requires requireAuth | FAIL | requireAuth not on /sincronizar |
| E06 | POST /teams/sync requires requireAuth | FAIL | requireAuth not on /teams/sync |
...
| E13 | DELETE /fuentes/custom/:id requires requireAuth + uses JWT userId | FAIL | requireAuth not on DELETE /fuentes/custom/:id |
...
[
  ...
  },
  {
    ...
    "status": "PASS",
    "detail": "All: 3062, Nonsense search: 0 (filtered correctly)"
  },
  {
    "id": "B01",
  ...
  },
  {
    ...
    "status": "FAIL",
    "detail": "Does not compare userId with req.auth.userId"
  },
  {
    "id": "D03",
  ...
  {
    "id": "D06",
    "name": "JWT_SECRET warns in production",
    "status": "FAIL",
    "detail": "No production warning for missing JWT_SECRET"
  },
  {
    "id": "D07",
  ...
  },
  {
    ...
    "status": "FAIL",
    "detail": "requireAuth not on /upgrade route"
  },
  {
    "id": "E02",
  ...
  },
  {
    ...
    "status": "FAIL",
    "detail": "requireAuth not on /sincronizar"
  },
  {
    "id": "E06",
    "name": "POST /teams/sync requires requireAuth",
    "status": "FAIL",
    "detail": "requireAuth not on /teams/sync"
  },
  {
    "id": "E07",
  ...
  },
  {
    ...
    "status": "FAIL",
    "detail": "requireAuth not on DELETE /fuentes/custom/:id"
  },
  {
    "id": "E14",
