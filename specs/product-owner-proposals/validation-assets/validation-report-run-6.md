# Validation Report -- Run 6

**Date**: 2026-03-26T22:20:42.126Z
**Summary**: 93/93 passed, 0 failed, 0 skipped
...
| A03 | Search API actually filters (live test) | PASS | All: 3044, Nonsense search: 0 (filtered correctly) |
...
| C13 | API tests pass with 91+ tests | PASS | 135 tests passed (>= 91 threshold) |
...
| D02 | /api/auth/upgrade has IDOR protection | PASS | IDOR protection: authenticated users can only upgrade their own account |
...
| D06 | JWT_SECRET warns in production | PASS | Logs warning if JWT_SECRET not set in production |
...
[
  ...
  },
  {
    ...
    "status": "PASS",
    "detail": "All: 3044, Nonsense search: 0 (filtered correctly)"
  },
  {
    "id": "B01",
  ...
  },
  {
    ...
    "status": "PASS",
    "detail": "135 tests passed (>= 91 threshold)"
  },
  {
    "id": "C14",
  ...
  },
  {
    ...
    "status": "PASS",
    "detail": "IDOR protection: authenticated users can only upgrade their own account"
  },
  {
    "id": "D03",
  ...
  },
  {
    ...
    "status": "PASS",
    "detail": "Logs warning if JWT_SECRET not set in production"
  },
  {
    "id": "D07",
