...
**Date**: 2026-03-26T16:28:51.017Z
**Summary**: 36/36 passed, 0 failed, 0 skipped
...
| A03 | Search API actually filters (live test) | PASS | All: 2803, Nonsense search: 0 (filtered correctly) |
...
[
  ...
  },
  {
    ...
    "status": "PASS",
    "detail": "All: 2803, Nonsense search: 0 (filtered correctly)"
  }
]
```
