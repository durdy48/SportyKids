...
const ASSETS = join(__dirname, '..', 'validation-assets', 'run-5');
...
function generateReport() {
  ...
  let md = `# Validation Report — Run 5 (post mobile fixes)\n\n`;
  md += `**Date**: ${now}\n`;
  ...
  const reportPath = join(ASSETS, '..', 'validation-report-run-5.md');
...
async function main() {
  console.log('🔍 SportyKids Validation — Run 5 (post mobile fixes)\n');
