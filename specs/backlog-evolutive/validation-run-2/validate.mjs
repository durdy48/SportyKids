...
const ASSETS = join(__dirname, '..', 'validation-assets', 'run-2');
...
function generateReport() {
  ...
  const reportPath = join(ASSETS, '..', 'validation-report-run-2.md');
...
async function main() {
  console.log('🔍 SportyKids Validation — Run 2 (post /t-review #1)\n');
