...
const ASSETS = join(__dirname, '..', 'validation-assets', 'run-4');
...
function generateReport() {
  ...
  let md = `# Validation Report — Run 4 (post /t-review #2)\n\n`;
  md += `**Date**: ${now}\n`;
  ...
  const reportPath = join(ASSETS, '..', 'validation-report-run-4.md');
...
async function main() {
  console.log('🔍 SportyKids Validation — Run 4 (post /t-review #2)\n');
