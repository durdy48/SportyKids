#!/usr/bin/env bash
# Admin Dashboard — Validation Run 6 (post /t-review #3)
...
REPORT_PATH="${SCRIPT_DIR}/../validation-assets/validation-report-run-6.md"
...
echo "=== Admin Dashboard — Validation Run 6 (post /t-review #3) ==="
...
mkdir -p "${SCRIPT_DIR}/../validation-assets/run-6/api"
mkdir -p "${SCRIPT_DIR}/../validation-assets/run-6/output"
