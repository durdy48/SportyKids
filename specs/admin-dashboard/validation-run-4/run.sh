#!/usr/bin/env bash
# Admin Dashboard — Validation Run 4 (Appendix B: post /t-review #2)
...
REPORT_PATH="${SCRIPT_DIR}/../validation-assets/validation-report-run-4.md"
...
echo "=== Admin Dashboard — Validation Run 4 (Appendix B: post /t-review #2) ==="
...
mkdir -p "${SCRIPT_DIR}/../validation-assets/run-4/api"
mkdir -p "${SCRIPT_DIR}/../validation-assets/run-4/output"
